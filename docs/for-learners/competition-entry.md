...
| 參賽資格 | Grade 8 或以下 |
| 題數/時間 | 25 題 / 40 分鐘 |
| 前置程度 | [美國 Grade 8 完整課綱](../Narrator/skill_alignment_map/Grade-8-Math) |
...
| 題數/時間 | 25 題 / 60 分鐘 |
| 前置程度 | [英國 Year 8 課綱](../Narrator/skill_alignment_map/UK-Year8-Math) |
...
AMC 10 ──┬── 前 2.5% ──→ AIME ──→ USAJMO ──→ MOP ──→ IMO
         │
AMC 12 ──┴── 前 2.5% ──→ AIME ──→ USAMO ──→ MOP ──→ IMO
```
...
JMC ──→ JMO ──┐
              │
IMC ──→ Cayley/Hamilton/Maclaurin ──→ BMO1 ──→ BMO2 ──→ IMO
              │
SMC ──────────┘
```
