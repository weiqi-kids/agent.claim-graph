...
grand_parent: 年級技能標準
nav_order: 3
description: 美國 Common Core 國小三年級數學技能標準，包含運算與代數思維、以十為基底的數字系統、分數、測量與數據、幾何共 25 項技能。
...
> 對應美國 Common Core Grade 3 Math

## 資料來源

本報告的所有內容來自:
- [Common Core State Standards Initiative](https://www.thecorestandards.org/Math/Content/3/)
- 資料擷取時間: 2026-02-08
...
| CCSS.Math.Content.3.MD.A.2 | Measure and estimate liquid volumes and masses of objects using standard units of grams (g), kilograms (kg), and liters (l). Add, subtract, multiply, or divide to solve one-step word problems involving masses or volumes that are given in the same units. |
