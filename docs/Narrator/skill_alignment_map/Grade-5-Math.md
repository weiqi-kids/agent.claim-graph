...
grand_parent: 年級技能標準
nav_order: 5
description: 美國 Common Core 國小五年級數學技能標準，包含運算與代數思維、以十為基底的數字系統、分數、測量與數據、幾何共 26 項技能。
...
> 對應美國 Common Core Grade 5 Math

## 資料來源

本報告的所有內容來自:
- [Common Core State Standards Initiative](https://www.thecorestandards.org/Math/Content/5/)
- 資料擷取時間: 2026-02-08
