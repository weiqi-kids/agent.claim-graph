...
```bash
# 完整健檢
./revamp/tools/site-audit.sh https://example.com --output discovery-report.json

# 或分項執行
./revamp/tools/site-audit.sh https://example.com --lighthouse
./revamp/tools/site-audit.sh https://example.com --security
./revamp/tools/site-audit.sh https://example.com --seo
```
